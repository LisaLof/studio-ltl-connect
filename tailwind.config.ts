...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        // Avenir Next approximation using system fonts
        heading: ['"Avenir Next"', 'Avenir', 'Montserrat', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'sans-serif'],
      ...
      fontSize: {
        ...
        'menu': ['15px', { lineHeight: '1.4', fontWeight: '500' }],
